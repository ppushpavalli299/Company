sap.ui.define([
    ...
    "sap/ui/model/Sorter",
    "sap/ui/Device",
    "project/utils/TablePersonalizationEngine"
], function (
    ...
    return Controller.extend("project.controller.BaseController", {
        ...
        handleGroupButtonPressed: async function () {
            const oDialog = await this.getViewSettingsDialog("project.view.fragment.GroupDialog");
            oDialog.open();
        },
        ...
        handleSortButtonPressed: async function () {
            ...
            if (!this.oSortDialog) {
                this.oSortDialog = await Fragment.load({
                    name: "project.view.fragment.SortDialog",
                    controller: this
                });
        ...
        handlePersoButtonPressed: async function () {
            if (!this._persoDialog) {
                this._persoDialog = await Fragment.load({
                    name: "project.view.fragment.TablePersoDialog",
                    controller: this
                });
