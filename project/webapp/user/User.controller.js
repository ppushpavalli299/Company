sap.ui.define([
  ...
  return BaseController.extend("project.user.User", {
    formatter: Formatter,
      ...
      const aDummyUsers = [
        {
          ...
          designation: "Manager",
          createdBy: "Admin",
          createdOn: new Date(2026, 2, 1), // March 1, 2026
          status: 2
        },
        {
          id: "U002",
        ...
        },
        {
          ...
          designation: "HR",
          createdBy: "Admin",
          createdOn: new Date(2026, 2, 5),
          status: 2
        }
      ];

      this.getView().setModel(new JSONModel(aDummyUsers), "userMdl");
    },
